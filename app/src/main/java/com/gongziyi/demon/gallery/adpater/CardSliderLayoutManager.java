...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    private static final int DEFAULT_ACTIVE_CARD_LEFT_OFFSET = 30;
    private static final int DEFAULT_CARD_WIDTH = 130;
        ...
        while (pos < anchorPos) {
            ...
            if (view != null) {
                ...
                try {
                    ...
                    view = recycler.getViewForPosition(pos-1);
                    addView(view);
                    measureChildWithMargins(view, 0, 0);
                    final int viewHeight = getDecoratedMeasuredHeight(view);
                    layoutDecorated(view, viewLeft, 0, viewLeft + cardWidth, viewHeight);
